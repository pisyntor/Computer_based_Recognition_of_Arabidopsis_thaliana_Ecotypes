...
### Publication
This work has been publish in The Plant Phenome Journal: Sarić, R., Čustović, E., Akagić, A., Trtílek, M., Lewsey, M. G., and Whelan, J. (2025). Computer vision-based recognition and distinction of Arabidopsis thaliana ecotypes using supervised deep learning models. The Plant Phenome Journal, 8, e70041. [Access](https://acsess.onlinelibrary.wiley.com/doi/10.1002/ppj2.70041)
